    ...
    for(var i=0;i<3;i++){
        if(position[i][0]==position[i][1]&&position[i][1]==position[i][2]&&position[i][0]!=0){
            if(position[i][0]==true){
                document.write("<img src='8f3f5b93f7f2519ffb232b175559a7a3.jpeg' width=\"90%\" height=\"auto\"/>")
                window.alert("You Win!");
                setTimeout('open("https://mac1xa3.ca/u/wangx308/simpleapp.html","_self")',2000);
                return true;
            }
            else {
                document.write("<img src='a51007e923e22ffecbff266ee080a71e.png' width=\"90%\" height=\"auto\"/>")
